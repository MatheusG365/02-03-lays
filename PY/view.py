...
def grafico():
    ...
    try:
        ...
        return jsonify({"mensagem": "Tokem Expirado"}), 401
...
def criar_livro():
    try:
        ...
        if cur.fetchone():
            return jsonify({"message":"livro ja cafastrado"}), 400
